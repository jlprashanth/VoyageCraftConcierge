...
def get_memory_service():
    """Process-wide memory service: Vertex AI Memory Bank using deployed Agent Engine ID."""
    ...
    return VertexAiMemoryBankService(
        project="qwiklabs-gcp-02-6c97d9d7ae82",
        location="us-central1",
        agent_engine_id="879833052837052416",
    )
